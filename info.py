...
#ai
OPENAI_API = environ.get("OPENAI_API","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")
AI = is_enabled((environ.get("AI","True")), False)
LAZY_AI_LOGS = int(environ.get("LAZY_AI_LOGS","-1001930977544")) #GIVE YOUR NEW LOG CHANNEL ID TO STORE MESSAGES THAT THEY SEARCH IN BOT PM.... [ i have added this to keep an eye on the users message, to avoid misuse of LazyPrincess ]
